...
function bubbleChart() {
  ...
  function showDetail(d) {
    ...
    d3.select(this).attr('stroke', 'black').style("fill", "green");

    var content = '<span class="name">Word: </span><span class="value">' +
                  d.name +
                  '</span><br/>' +
                  '<span class="name">Word Count: </span><span class="value">' +
                  d.value +
                  '</span><br/>' +
...
// Load the data.
d3.csv('data/word_count.csv', display);
